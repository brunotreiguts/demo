...
return array(
    ...
    'groups' => array(
        ...
        1 => array('name' => 'FAQeditor', 'roles' => array('faqeditor')),
        30 => array('name' => 'MaterialEditor', 'roles' => array('materialeditor','faqeditor')),
        50 => array('name' => 'User', 'roles' => array('user','materialeditor','faqeditor')),
        100 => array('name' => 'Administrators',
            'roles' => array('faqeditor','materialeditor','user', 'admin')),
    ),
    /**
